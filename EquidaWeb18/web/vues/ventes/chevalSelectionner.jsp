...
<html>
    <head>
        ...
        <title>SELECTIONNER LES CHEVAUX</title>
    </head>
    <body>
        <h1>SELECTION DES CHEVAUX</h1>
        
         <%
        ArrayList<Lot> lesLots = (ArrayList)request.getAttribute("pLesLots");
        %>
        
        <form class="form-inline" action="selectionnerCheval" method="POST">  
                    ...
                    for(int i = 0; i < lesLots.size();i++)
                    {
                        ...
                        if(unCheval.getLesParticipation() != null){
                            for(int j = 0; j < unCheval.getLesParticipation().size();j++)
                            {
                                ...
                                <INPUT type= "checkbox" name="<% out.println(unCheval.getId());%>"  value="true">
